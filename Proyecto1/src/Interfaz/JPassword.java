...
public class JPassword extends JPasswordField {
    ...
    public JPassword(final Document pDoc,final String pText,final int pColumns){
        super(pDoc, pText, pColumns);
    }
    public JPassword(final int pColumns) {
        super(pColumns);
    }
    public JPassword(final String pText) {
        super(pText);
    }
    public JPassword(final String pText, final int pColumns) {
