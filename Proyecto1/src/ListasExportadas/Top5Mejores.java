...
public class Top5Mejores {
	private int alu;
	private double acum;
	public Top5Mejores(int alu,double acum) {
		this.setAlu(alu);
		this.setAcum(acum);
	}
	public static void Exportar(int cur,String nom) {
		try {
            ...
            PdfWriter.getInstance(document, new FileOutputStream("Listados/Top5Mejores.pdf"));
            document.open();
	...
	private static void addTitlePage(Document document,int cur,String nom)
        ...
        preface.add(new Paragraph("Alumnos Con Mejor Desempeño En "+nom,catFont));
