...
public class JacobiVoyageSintaxis {
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		System.err.println("Método Iterativo de Jacobi");
		...
		double[] x = new double[aum.length];
		System.out.print("\nX(0) = ");
		String x0 = sc.next();
		for(int i = 0; i < x.length; i ++) {
			x[i] = Double.parseDouble(x0);
		}
		System.out.print("\nTolerancia = ");
		String tolerancia = sc.next();	
		...
		System.out.println("\n"+jacobi(aum,x,lit,Double.parseDouble(tolerancia)));
		sc.close();
	}
	public static String jacobi(double[][] aum,double[] x,String[] lit,double tolerancia) {
