...
import Menu.Menu;
public class ReportePokemonsSalvajes {
	public static void reportar() {
		if(pokemons!=null) {
			try {
				FileWriter reporte = new FileWriter("Reportes/PokemonSalvajes.html");
				...
				for(int i=0; i<pokemons.length; i++) {
					if(pokemons[i]!=null && pokemons[i].capturado==false) {
						String estado;
						if(pokemons[i].estado==true) {
							estado="Vivo";
						}else {
							estado="Muerto";
						}
						reporte.write("<tr class=\"row100 body\">\r\n");
						reporte.write("<td class=\"cell100 column6\">"+pokemons[i].id+"</td>\r\n");
						reporte.write("<td class=\"cell100 column2\">"+pokemons[i].tipo+"</td>\r\n");
						reporte.write("<td class=\"cell100 column2\">"+pokemons[i].nombre+"</td>\r\n");
						reporte.write("<td class=\"cell100 column3\">"+pokemons[i].vida+"</td>\r\n");
						reporte.write("<td class=\"cell100 column3\">"+pokemons[i].puntosAtaque+"</td>\r\n");
						reporte.write("<td class=\"cell100 column4\">Salvaje</td>\r\n");
						reporte.write("<td class=\"cell100 column4\">"+estado+"</td>\r\n");
						reporte.write("</tr>\r\n");
						//System.out.println(pokemons[i].id+" "+pokemons[i].tipo+" "+pokemons[i].nombre+" "+"Salvaje");
					}
				}
				reporte.write("</tbody>\r\n"
						+ "						</table>\r\n"
